// Cloudflare Pages Function, POST /api/temp-check/log
// Proxies temp-check result payloads to the VPS tools_server for JSONL logging.

const VPS_URL = "https://api.mexzungu.com/dashboard/temp-check/log";
